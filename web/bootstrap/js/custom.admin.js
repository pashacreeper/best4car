$(document).ready(function(){
    var serviceSelectByType = function() {
        $('select.auto_service_select').each(function() {
            var optionsByType = [];
            ...
            var typeSelect = $(this).parents('tr').find('select.auto_specialization_select_company');
            if(!typeSelect.length) {
                typeSelect = $(this).parents('.field-container').find('.auto_specialization_select');
            }
            if(!typeSelect.length) {
