 ...
 */
class Version20140619150830 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("CREATE TABLE custom_modifications (id INT AUTO_INCREMENT NOT NULL, engineType VARCHAR(255) DEFAULT NULL, engineModel VARCHAR(255) DEFAULT NULL, engineVolume INT DEFAULT NULL, enginePower INT DEFAULT NULL, fuelTypes LONGTEXT DEFAULT NULL COMMENT '(DC2Type:array)', wheelType VARCHAR(255) DEFAULT NULL, bodyType VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
        $this->addSql("ALTER TABLE user_cars ADD custom_modification_id INT DEFAULT NULL, DROP engineVolume, DROP engineType, DROP engineModel, DROP enginePower, DROP fuelTypes, DROP wheelType, DROP bodyType");
